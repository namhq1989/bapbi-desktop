...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SharedPreferences storage, ThemeMode mode});
}
...
class _$ThemeStateImpl implements _ThemeState {
  _$ThemeStateImpl({required this.storage, required this.mode});
  ...
  @override
  String toString() {
    return 'ThemeState(storage: $storage, mode: $mode)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, storage, mode);
...
abstract class _ThemeState implements ThemeState {
  factory _ThemeState(
      {required final SharedPreferences storage,
      required final ThemeMode mode}) = _$ThemeStateImpl;
